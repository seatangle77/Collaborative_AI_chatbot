...
def generate_response(bot_id: str, main_prompt: str, history_prompt: str = None, prompt_type: str = "real_time_summary", model: str = "grok-2-latest", api_provider: str = None):
    """
    ...
    if api_provider == "xai":
        return generate_xai_response(bot_id, main_prompt, history_prompt, prompt_type, model)
    elif api_provider == "hkust_gz":
        return generate_hkust_response(bot_id, main_prompt, history_prompt, prompt_type, model)
    elif api_provider == "gemini":
        return generate_gemini_response(bot_id, main_prompt, history_prompt, prompt_type, model)
    else:
